# Trained SemAE Aspect Inference Report &mdash; `space_hasos_full_e20_ranked`
...
| --- | --- | ---: | ---: | ---: | ---: | ---: |
| LOYALTY | `LOY_RECOMMEND` | 50 | 0 | 112.2 | 48/50 | 0.96 |
| EXPERIENCE | `EXP_OVERALL` | 50 | 0 | 110.9 | 49/50 | 0.98 |
| SERVICE | `SER_ATTITUDE` | 50 | 0 | 115.0 | 49/50 | 0.98 |
| AMENITY | `AM_ENT` | 50 | 0 | 102.6 | 50/50 | 1.00 |
| AMENITY | `AM_FOOD` | 50 | 0 | 107.5 | 50/50 | 1.00 |
| AMENITY | `AM_POOL` | 50 | 10 | 106.8 | 40/40 | 1.00 |
| AMENITY | `AM_ROOM_UTIL` | 50 | 0 | 107.1 | 50/50 | 1.00 |
| AMENITY | `AM_TRANSPORT` | 50 | 0 | 106.2 | 50/50 | 1.00 |
| AMENITY | `AM_UTILITY` | 50 | 18 | 104.4 | 32/32 | 1.00 |
| AMENITY | `AM_WELLNESS` | 50 | 12 | 110.5 | 38/38 | 1.00 |
| AMENITY | `AM_WIFI` | 50 | 0 | 106.5 | 50/50 | 1.00 |
| BRANDING | `BRA_LUXURY` | 50 | 4 | 108.1 | 46/46 | 1.00 |
| BRANDING | `BRA_REPUTE` | 50 | 0 | 108.6 | 50/50 | 1.00 |
| EXPERIENCE | `EXP_EMOTION` | 50 | 2 | 109.7 | 48/48 | 1.00 |
| EXPERIENCE | `EXP_SAFETY` | 50 | 2 | 108.9 | 48/48 | 1.00 |
| EXPERIENCE | `EXP_VALUE` | 50 | 0 | 109.6 | 50/50 | 1.00 |
| FACILITY | `FAC_BATH` | 50 | 0 | 110.1 | 50/50 | 1.00 |
| FACILITY | `FAC_BUILDING` | 50 | 0 | 107.0 | 50/50 | 1.00 |
| FACILITY | `FAC_CLIMATE` | 50 | 3 | 104.1 | 47/47 | 1.00 |
| FACILITY | `FAC_ENV` | 50 | 0 | 104.8 | 50/50 | 1.00 |
| FACILITY | `FAC_INTERIOR` | 50 | 0 | 106.5 | 50/50 | 1.00 |
| FACILITY | `FAC_ROOM` | 50 | 0 | 108.9 | 50/50 | 1.00 |
| FACILITY | `FAC_SECURITY` | 50 | 12 | 103.3 | 38/38 | 1.00 |
| FACILITY | `FAC_VIEW_LOCATION` | 50 | 0 | 107.9 | 50/50 | 1.00 |
| LOYALTY | `LOY_PREFERENCE` | 50 | 8 | 108.2 | 42/42 | 1.00 |
| LOYALTY | `LOY_RETURN` | 50 | 0 | 112.0 | 50/50 | 1.00 |
| SERVICE | `SER_COMM` | 50 | 9 | 109.4 | 41/41 | 1.00 |
| SERVICE | `SER_OPERATION` | 50 | 0 | 105.4 | 50/50 | 1.00 |
| SERVICE | `SER_SUPPORT` | 50 | 0 | 102.0 | 50/50 | 1.00 |
...
- `dev_100597`: The shuttle will drop you at the airport train station if you are going to Seattle, but on your way back you must walk from the station to the shuttle bus pick up area at the airport(about a 5 to 10 m…
